...
local function main( ... )
	...
	mj:printMT()
	-- local outCard = Card.new(0x06);--模拟玩家出了6万
	-- local ret = mj:check_left_chi(outCard)
	-- if ret then
	-- 	dump(ret)
	-- end

	-- local ret = mj:check_right_chi(outCard)
	-- if ret then
	-- 	dump(ret)
	-- end

	-- local ret = mj:check_middle_chi(outCard)
	-- if ret then
	-- 	dump(ret)
	-- end
	-- mj:remove(ret)
